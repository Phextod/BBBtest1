...
public class HelloWorld   implements Copyable, Serializable{
    ...
    public String str= (String)""; /* maximum length = (255) */
    ...
    */
    ...
    public String toString(String desc, int indent) {
        ...
        strBuffer.append("str: ").append(str).append("\n");  
